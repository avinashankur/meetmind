...
_(Note: When called as an internal helper by another orchestrator like `git-stage`, return the message without prompting, allowing the parent skill to manage commits.)_
